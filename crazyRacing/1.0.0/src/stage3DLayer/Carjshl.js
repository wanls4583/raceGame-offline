...
stage3DLayer.Carjshl = function () {
    ...
    globalDispatcher.addEventListener('superRunning', function (e) {
        s.effectTimes += 60;
...
F2xExtend(stage3DLayer.Carjshl, F2xMovieClip);
stage3DLayer.Carjshl.prototype.initUI = function () {
    var s = this;
    //f2x_auto_created_init_start
	var _d0=new stage3DLayer.F2xAuto_142();
	_d0.name="speedLine";
	s.speedLine=_d0;
	var _d1=new stage3DLayer.F2xAuto_143();
	_d1.name="effect0";
	s.effect0=_d1;
	var _d2=new stage3DLayer.F2xAuto_144();
	_d2.name="effect3";
	s.effect3=_d2;
	var _d3=new stage3DLayer.F2xAuto_145();
	_d3.name="effect2";
	s.effect2=_d3;
	var _d4=new stage3DLayer.F2xAuto_146();
	_d4.name="effect1";
	s.effect1=_d4;
	var _d5=new stage3DLayer.F2xAuto_140();
	var _d6=new stage3DLayer.F2xAuto_138();
	s.a().b(7).b(7).b(1);
...
stage3DLayer.Carjshl.prototype.isChangingLanes = false;
stage3DLayer.Carjshl.prototype.isCarHasEffect = false;
stage3DLayer.Carjshl.prototype.effectType = 0;//特效类型
stage3DLayer.Carjshl.prototype.posStatus = 0;//0中，1左，2右
stage3DLayer.Carjshl.prototype.creatSupperEffect = function () {
    var s = this;
    //如果有使用护盾效果
    ...
    //根据速度判断
    if (globalAddspeed < (CarConfig.maxSpeed * 10) * 0.33) {
        s.effect1.visible = s.effect2.visible = s.effect3.visible = false
    } else if (globalAddspeed > (CarConfig.maxSpeed * 10) * 0.33 && globalAddspeed < (CarConfig.maxSpeed * 10) * 0.66) {
        //速度达到3/1
...
stage3DLayer.Carjshl.prototype.updateSuperEffect = function () {
    var s = this;
    s.creatSupperEffect();//实时更新喷射特效
}
stage3DLayer.Carjshl.prototype.getCarInfo = function () {
    var s = this;
